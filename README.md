...
| [certs/gen-mtls-ca.sh](certs/gen-mtls-ca.sh) | Generates the self-signed CA bundle and a sample client cert |
...
./certs/gen-mtls-ca.sh                          # generate CA + client cert
terraform init
terraform apply
```
...
- The trust store uses a **self-signed CA** generated by `certs/gen-mtls-ca.sh`
